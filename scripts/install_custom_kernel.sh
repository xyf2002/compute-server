...
sudo cp "${DOWNLOAD_DIR}/chronos-kernel-backup-${VERSION}/vmlinuz-${VERSION}" /boot/
sudo cp "${DOWNLOAD_DIR}/chronos-kernel-backup-${VERSION}/initrd.img-${VERSION}" /boot/
sudo cp "${DOWNLOAD_DIR}/chronos-kernel-backup-${VERSION}/System.map-${VERSION}" /boot/
sudo cp "${DOWNLOAD_DIR}/chronos-kernel-backup-${VERSION}/config-${VERSION}" /boot/
sudo cp -r "${DOWNLOAD_DIR}/chronos-kernel-backup-${VERSION}/modules/${VERSION}" /lib/modules/
